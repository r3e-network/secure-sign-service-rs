...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SignExtensiblePayloadResponse {
    /// script hash -> account signs, one to one mapping
    #[prost(message, repeated, tag = "1")]
    pub signs: ::prost::alloc::vec::Vec<::secure_sign_core::neo::signpb::AccountSigns>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SignBlockRequest {
    /// the block header to be signed
    #[prost(message, optional, tag = "1")]
    pub block: ::core::option::Option<::secure_sign_core::neo::signpb::TrimmedBlock>,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/servicepb.SecureSign/SignExtensiblePayload" => {
                    ...
                    let fut = async move {
                        let method = SignExtensiblePayloadSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
